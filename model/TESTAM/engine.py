...
class trainer():
    def __init__(self, scaler, in_dim, seq_length, num_nodes, nhid, dropout, device, lr_mul=1., n_warmup_steps=2000,
                 quantile=0.7, is_quantile=False, warmup_epoch=0):
        ...
        self.schedule = util.CosineWarmupScheduler(self.optimizer, d_model=nhid, n_warmup_steps=n_warmup_steps,
                                                   lr_mul=lr_mul)
