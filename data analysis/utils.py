...
def avg_top_sensors(start_time, end_time, n):
    ...
    wedges, texts, autotexts = ax.pie(
        ...
        startangle=140,
        colors=plt.cm.Paired(np.arange(len(top_sensors))),
...
def avg_bottom_sensors(start_time, end_time, n):
    ...
    wedges, texts, autotexts = ax.pie(
        ...
        startangle=140,
        colors=plt.cm.Paired(np.arange(len(bottom_sensors))),
        textprops=dict(color="w"),
    )
    plt.setp(autotexts, size=10, weight="bold")
    plt.setp(texts, size=15, weight="bold")
...
def avg_top_street(start_time, end_time, n):
    ...
    wedges, texts, autotexts = ax.pie(
        ...
        startangle=140,
        colors=plt.cm.Paired(np.arange(len(top_street))),
        textprops=dict(color="w"),
    )
    ...
    ax.legend(wedges, top_street.index,
              ...
              bbox_to_anchor=(1, 0, 0.5, 1),
              fontsize='13')
    plt.title('Top {} Street Average Speeds from {} to {}'.format(n, start_time, end_time), fontsize=14,
              weight='bold')
    plt.tight_layout()
    plt.show()
...
def avg_bottom_street(start_time, end_time, n):
    ...
    wedges, texts, autotexts = ax.pie(
        ...
        startangle=140,
        colors=plt.cm.Paired(np.arange(len(bottom_street))),
        textprops=dict(color="w"),
    )
    plt.setp(autotexts, size=12, weight="bold")
    plt.setp(texts, size=15, weight="bold")
...
if __name__ == '__main__':
    ...
    # avg_top_street('2024-05-01 00:00:00', '2024-05-02 00:00:00', 10)
    # avg_bottom_street('2024-05-01 00:00:00', '2024-05-02 00:00:00', 10)
