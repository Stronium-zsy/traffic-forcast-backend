...
# ******************************************<传感器级别车速，车流量统计>******************************************
def top_speed_sensors(timestep, n):
...
def top_flow_sensors(timestep, n):
...
def bottom_speed_sensors(timestep, n):
    data = pd.read_csv('speed_data.csv')
    data.set_index('time', inplace=True)
...
def bottom_flow_sensors(timestep, n):
    data = pd.read_csv('flow_data.csv')
    data.set_index('time', inplace=True)
...
def avg_top_speed_sensors(start_time, end_time, n):
    data = pd.read_csv('speed_data.csv')
    data.set_index('time', inplace=True)
...
def avg_top_flow_sensors(start_time, end_time, n):
    data = pd.read_csv('flow_data.csv')
    data.set_index('time', inplace=True)
...
def avg_bottom_speed_sensors(start_time, end_time, n):
    data = pd.read_csv('speed_data.csv')
    data.set_index('time', inplace=True)
...
def avg_bottom_flow_sensors(start_time, end_time, n):
    data = pd.read_csv('flow_data.csv')
    data.set_index('time', inplace=True)
...
# ******************************************<街道级别车速，车流量统计>******************************************
def top_speed_street(timestep, n):
...
def top_flow_street(timestep, n):
    with open('sensor_street.json', 'r') as f:
        json_data = json.load(f)
...
def bottom_speed_street(timestep, n):
    with open('sensor_street.json', 'r') as f:
        json_data = json.load(f)
...
def bottom_flow_street(timestep, n):
    with open('sensor_street.json', 'r') as f:
        json_data = json.load(f)
...
def avg_top_speed_street(start_time, end_time, n):
    with open('sensor_street.json', 'r') as f:
        json_data = json.load(f)
...
def avg_top_flow_street(start_time, end_time, n):
    with open('sensor_street.json', 'r') as f:
        json_data = json.load(f)
...
def avg_bottom_speed_street(start_time, end_time, n):
    with open('sensor_street.json', 'r') as f:
        json_data = json.load(f)
...
def avg_bottom_flow_street(start_time, end_time, n):
    with open('sensor_street.json', 'r') as f:
        json_data = json.load(f)
...
def flow_distribution(start_time, end_time):
    data = pd.read_csv('flow_data.csv')
    data.set_index('time', inplace=True)
...
def plot_sensor_flow(sensorid, start_time, end_time):
    data = pd.read_csv('flow_data.csv')
    data.set_index('time', inplace=True)
...
def plot_street_flow(street, start_time, end_time):
    with open('sensor_street.json', 'r') as f:
        data = json.load(f)
    sensor_list = data[street]
